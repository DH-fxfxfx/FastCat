        ...
        <ul class="lv-indexlist__content" id="lv-indexlist__content">
          <div class="recommend-city">
            ...
            <div class="hot-city">
              ...
              <ul class="city-index-detail">
                <li class="city-item-detail" v-for="city in hotList" :key="city.cityId">
          ...
          <van-index-bar>
            <div v-for="item in newCityList"  :key="item.py" >
              <van-index-anchor   :index=" item.py "/>
              <van-cell v-for="city in item.list" :key="city.cityId" :title="city.name"/>
            </div>
          </van-index-bar>
        </ul>
